...
<!--ここから書き換え-->
	<div class="processing">
		...
		<div class="tableViewer">
			<form action="<%=request.getContextPath()%>/ProductUpdateCheck" name="input" method="post">
				<!--上段テーブル-->
				...
				<div class="inputButton">
					...
					<input type="submit" value="確認" onclick="return checkOnClick({ productName: '商品名', price: '価格', explainText: '説明文', imageUrl: '画像URL' },['price'],'編集')"/>
				</div>
			</form>
