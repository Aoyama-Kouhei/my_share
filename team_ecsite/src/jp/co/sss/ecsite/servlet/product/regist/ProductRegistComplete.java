 ...
 */
@WebServlet("/ProductRegistComplete")
public class ProductRegistComplete extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 商品登録完了画面へ遷移
		request.getRequestDispatcher("/jsp/product/regist/product_regist_complete.jsp").forward(request, response);
	}
}
